...
def main():
    ...
    urdf_dir = args_cli.input
    urdf_list = glob.glob(os.path.join(urdf_dir, "*", "*", "*", "*_015.urdf"), recursive=True)
    for urdf_path in urdf_list:
        ...
        dest_path = os.path.join(dest_dir, os.path.basename(os.path.dirname(os.path.dirname(urdf_path))) + ".usd")
